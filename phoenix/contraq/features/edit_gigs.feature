...
Scenario Outline: Basic gig editing
  ...
  And I fill in the following:
    ...
    | State      | <new_state>  |
    | Zip        | <new_zip>    |
    # TODO: Keeping these commented out because they will be implemented soon.
...
Scenario: Link to edit from detail page
  Given I am logged in
  And I have a gig
  And I am on the gig's page
  When I click "Edit gig"
  Then I should be on the edit page for the gig
